...
const PmCGV = () => {
  return (
    <section className="cgv--container">
      ...
      <p>
        1.1 Site (ci-après « le site ») : <strong>Sayfemums</strong>
        <br />
        1.2 Éditeur (ci-après « l'éditeur ») : L'entreprise individuelle
        Sayfemums située : 9 rue de Vienne, GISORS immatriculée au RCS de GISORS
        98262855400015 n° de téléphone : 0674310687 adresse mail :
        sayfemums@gmail.com
        <br />
        1.3 Hébergeur (ci-après « l'hébergeur ») : Sayfemums est hébergé par
        Render, dont le siège social est situé 525 Brannan St Suite 300 San
      ...
      <p>
        ...
        et données que vous consultez. L'éditeur ne pourra être tenu responsable
        en cas de poursuites judiciaires à votre encontre : - du fait de l'usage
        du site ou de tout service accessible via Internet ; - du fait du
        non-respect par vous des présentes conditions générales. L'éditeur n'est
        pas responsable des dommages causés à vous-même, à des tiers et/ou à
        votre équipement du fait de votre connexion ou de votre utilisation du
        site et vous renoncez à toute action contre lui de ce fait. Si l'éditeur
        venait à faire l'objet d'une procédure amiable ou judiciaire en raison
        de votre utilisation du site, il pourra se retourner contre vous pour
        obtenir l'indemnisation de tous les préjudices, sommes, condamnations et
      ...
      <p>
        Vos données sont collectées par l'entreprise individuelle Sayfemums. Une
        ...
        ou indirectement, notamment par référence à un nom, un numéro
      ...
      <p>
        ...
        caractère personnel, les utilisateurs disposent des droits suivants : le
        ...
        électronique ci-dessous mentionnée. Dans ce cas, avant la mise en œuvre
        de ce droit, la Plateforme peut demander une preuve de l'identité de
        ...
        Plateforme sont inexactes, ils peuvent demander la mise à jour des
        informations ; 
        ...
        s’opposer à ce que leurs données soient traitées conformément aux
        hypothèses prévues par le RGPD ; 
        le droit à la portabilité : ils peuvent
        réclamer que la Plateforme leur remette les données personnelles qu'ils
        ont fournies pour les transmettre à une nouvelle Plateforme. Vous pouvez
        exercer ce droit en nous contactant, à l’adresse suivante : 9 rue de
        Vienne GISORS. Ou par email, à l’adresse : sayfemums@gmail.com Toute
        demande doit être accompagnée de la photocopie d’un titre d’identité en
        cours de validité signé et faire mention de l’adresse à laquelle
        l'éditeur pourra contacter le demandeur. La réponse sera adressée dans
        le mois suivant la réception de la demande. Ce délai d'un mois peut être
        prolongé de deux mois si la complexité de la demande et/ou le nombre de
        demandes l'exigent. De plus, et depuis la loi n°2016-1321 du 7 octobre
        2016, les personnes qui le souhaitent, ont la possibilité d’ organiser
        le sort de leurs données après leur décès. Pour plus d’information sur
        le sujet, vous pouvez consulter le site Internet de la CNIL :
        https://www.cnil.fr/. Les utilisateurs peuvent aussi introduire une
        réclamation auprès de la CNIL sur le site de la CNIL :
        https://www.cnil.fr. Nous vous recommandons de nous contacter dans un
        premier temps avant de déposer une réclamation auprès de la CNIL, car
      ...
      <p>
        ...
        accès et utilisation de la Plateforme par l'utilisateur ; - gestion du
        fonctionnement et optimisation de la Plateforme ; - mise en œuvre d'une
        assistance utilisateurs ; - vérification, identification et
      ...
      <p>
        ...
        la Plateforme, des informations accessibles au public ; - quand
        ...
        dans le cadre de l'exécution de ces prestations, et ont l'obligation
        ...
        personnel ; - si la loi l'exige, la Plateforme peut effectuer la
      ...
      <p>
        ...
        Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant :
        sayfemums@gmail.com. Vos données sont susceptibles d’être utilisées par
        les partenaires de l'éditeur à des fins de prospection commerciale, si
        vous ne le souhaitez pas, veuillez cliquer sur le lien suivant :
        sayfemums@gmail.com. Si, lors de la consultation du site, vous accédez à
        des données à caractère personnel, vous devez vous abstenir de toute
        collecte, de toute utilisation non autorisée et de tout acte pouvant
        constituer une atteinte à la vie privée ou à la réputation des
        personnes. L'éditeur décline toute responsabilité à cet égard. Les
      ...
      <p>
        ...
        de l'utilisation d'un logiciel ou d'une application mobile et ce, quel
        ...
        informations collectées indirectement ne seront utilisées que pour
        ...
        améliorer le service que nous vous offrons. Le cas échéant, des «
        cookies » émanant de l'éditeur du site et/ou des sociétés tiers pourront
        être déposés sur votre terminal, avec votre accord. Dans ce cas, lors de
        la première navigation sur ce site, une bannière explicative sur
        ...
        l’utilisation desdits « cookies ». Le consentement donné sera valable
        pour une période de treize (13) mois. L'utilisateur a la possibilité de
        désactiver les cookies à tout moment. Les cookies suivants sont présents
        sur ce site : Cookies Google : - Google analytics : permet de mesurer
        l'audience du site ; - Google tag manager : facilite l’implémentation
        des tags sur les pages et permet de gérer les balises Google ; - Google
        Adsense : régie publicitaire de Google utilisant les sites web ou les
        vidéos YouTube comme support pour ses annonces ; - Google Dynamic
        Remarketing : permet de vous proposer de la publicité dynamique en
        fonction des précédentes recherches ; - Google Adwords Conversion :
        outil de suivi des campagnes publicitaires adwords ; - DoubleClick :
        cookies publicitaires de Google pour diffuser des bannières. Cookies
        Facebook : - Facebook connect : permet de s'identifier à l'aide de son
        compte Facebook ; - Facebook social plugins : permet de liker, partager,
        commenter du contenu avec un compte Facebook ; - Facebook Custom
        Audience : permet d'intérargir avec l'audience sur Facebook. Cookies
        Twitter : - Twitter button : permet de partager facilement et afficher
        le contenu de Twitter ; - Twitter advertising : permet d'afficher et de
        cibler des publicités par la régie publicitaire de Twitter. La durée de
        vie de ces cookies est de treize mois.
      </p>
      ...
      <p>
        ...
        l'adresse suivante : sayfemums@gmail.com.
      </p>
      </div>
    </section>
  );
